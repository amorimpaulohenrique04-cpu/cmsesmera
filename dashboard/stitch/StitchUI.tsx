...
export const Card = styled.section`
  border:1px solid color-mix(in srgb, ${t.color.line} 55%, transparent);border-radius:12px;background:${t.color.surfaceLowest};box-shadow:${t.shadow.card};padding:24px;
`
export const FlatCard = styled.section`border:1px solid ${t.color.line};border-radius:12px;background:${t.color.surfaceLowest};padding:20px;`
...
export const PrimaryButton = styled.a`
  ...
  &:hover{opacity:.9}.material-symbols-outlined{font-size:19px}
`
export const SecondaryButton = styled.a`
  display:inline-flex;min-height:40px;align-items:center;justify-content:center;gap:8px;border:1px solid ${t.color.line};border-radius:8px;background:${t.color.surfaceLowest};color:${t.color.ink};padding:0 16px;font-size:13px;font-weight:600;text-decoration:none;cursor:pointer;
  &:hover{background:${t.color.surfaceLow};border-color:${t.color.lineStrong}}.material-symbols-outlined{font-size:19px}
`
...
export const Pill = styled.span<{$tone?:'green'|'blue'|'red'|'sand'|'neutral'}>`
  display:inline-flex;min-height:24px;align-items:center;justify-content:center;border-radius:999px;padding:3px 9px;font-size:11px;font-weight:600;white-space:nowrap;
  ${({$tone='neutral'})=>{
...
export const SearchBox = styled.label`position:relative;display:block;min-width:260px;max-width:460px;flex:1;.material-symbols-outlined{position:absolute;left:14px;top:50%;transform:translateY(-50%);color:${t.color.lineStrong};font-size:20px}`
export const SearchInput = styled.input`width:100%;height:40px;border:1px solid transparent!important;border-radius:999px!important;background:${t.color.surfaceLow};padding:0 15px 0 44px;color:${t.color.ink};font-size:14px;&:focus{border-color:${t.color.primary}!important;box-shadow:0 0 0 1px ${t.color.primary}!important;outline:0}`
export const Table = styled.div`overflow:hidden;border:1px solid ${t.color.line};border-radius:12px;background:${t.color.surfaceLowest};`
...
export const Thumb = styled.div`display:grid;width:46px;height:46px;flex:0 0 46px;overflow:hidden;place-items:center;border-radius:8px;background:${t.color.surfaceContainer};color:${t.color.primary};img{width:100%;height:100%;object-fit:cover}.material-symbols-outlined{font-size:22px}`
...
export const Empty = styled.div`display:grid;min-height:180px;place-items:center;border:1px dashed ${t.color.line};border-radius:12px;background:${t.color.surfaceLow};padding:24px;color:${t.color.textSecondary};text-align:center;`
export const MiniBars = styled.div`display:flex;height:130px;align-items:flex-end;gap:12px;border-radius:12px;background:${t.color.surfaceLow};padding:20px 18px 0;`
...
export const DetailPanel = styled(Card)`position:sticky;top:16px;@media(max-width:1080px){position:static}`
...
export function MaterialIcon({children}: {children: ReactNode}) { return <span className="material-symbols-outlined">{children}</span> }
